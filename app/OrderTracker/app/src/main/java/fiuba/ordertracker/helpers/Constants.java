...
public final class Constants {
    ...
    public static final String COLOR_INDICATOR_DEFAULT = "#FFCCCCCC";
    public static final String COLOR_INDICATOR_VISITED = "#6FDD00";
    public static final String COLOR_INDICATOR_VISITED_OUT_OF_TIME = "#FF3E3E";
    public static final String COLOR_INDICATOR_NOT_VISITED = "#E7FD4A";
