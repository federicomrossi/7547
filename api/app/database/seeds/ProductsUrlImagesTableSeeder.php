...
class ProductsUrlImagesTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		$urlsTumbnail = array('http://pinkman.mx/wp-content/uploads/2013/12/Apple-TV.png',
		...
		$this->saveProducts('Tele', $urlsTumbnail, $urlsMini);
		...
		$urlsMini = array('https://www.walmartonline.com.ar/images/products/img_large/0779696260034L.jpg',
			'https://www.walmartonline.com.ar/images/products/img_large/0779696260399L.jpg',
			'https://www.walmartonline.com.ar/images/products/img_large/0779065305549L.jpg',);
		$this->saveProducts('Reme', $urlsTumbnail, $urlsMini);

		$urlsTumbnail = array('http://www.buenosairesrock.com.ar/Merch/TS32.jpg',
		...
		$urlsTumbnail = array('http://mla-s1-p.mlstatic.com/jeans-pantalones-jeans-calzas-201601-MLA20367900958_082015-Y.jpg',
		...
		$this->saveProducts('Pantal', $urlsTumbnail, $urlsMini);

		$urlsMini = array('http://mla-s1-p.mlstatic.com/juegos-comedor-4-sillas-sala-estar-comedor-155601-MLA20355626128_072015-S.jpg');
		$urlsTumbnail = array('http://mla-s2-p.mlstatic.com/mesa-y-sillas-comedor-wengue-guatambu-oferta-de-fabrica-240601-MLA20355624447_072015-O.jpg');
		$this->saveProducts('Mesa', $urlsTumbnail, $urlsMini);


		$urlsMini = array('http://mla-s1-p.mlstatic.com/juegos-comedor-4-sillas-sala-estar-comedor-155601-MLA20355626128_072015-S.jpg');
		$urlsTumbnail = array('http://mla-s1-p.mlstatic.com/4-silla-vestida-tapizada-en-chenille-390501-MLA20326632713_062015-O.jpg');
		$this->saveProducts('Silla', $urlsTumbnail, $urlsMini);

		$urlsMini = array('http://mla-s2-p.mlstatic.com/guitarra-amplificadores-710101-MLA20249658383_022015-S.jpg');
		$urlsTumbnail = array('http://mla-s1-p.mlstatic.com/amplificador-mini-puertos-usb-neoda-16522-MLA20123177787_072014-O.jpg');
		$this->saveProducts('Ampli', $urlsTumbnail, $urlsMini);


	}

	private function saveProducts($nameLike,$urlsTumbnail, $urlsMini)
	{
		$products = Product::where('nombre','like', "%".$nameLike.'%')->get();
		foreach ($products as $index => $product) {
			$product->url_image_tumbnail = $urlsTumbnail[array_rand($urlsTumbnail)];
